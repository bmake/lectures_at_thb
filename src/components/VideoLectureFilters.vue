...
export default {
  ...
  methods: {
    ...
    async getDepartments() {
      ...
      return axios
        .get('http://172.16.32.207:3000/v1/collegeOrUniversity', {
          headers: {
    ...
    async getStudyPrograms() {
      ...
      return axios
        .get(
          'http://172.16.32.207:3000/v1/studyProgram/collegeOrUniversity/' +
    ...
    async getModules() {
      ...
      return axios
        .get(
          'http://172.16.32.207:3000/v1/module/studyProgram/' +
